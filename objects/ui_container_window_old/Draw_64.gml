...
draw_text(id.x-20,id.y-20,"to_high:" + string(to_highlight))
if selected_slot!=noone{
draw_text(id.x+20,id.y-20,"slot_num:" + string(selected_slot.slot_num));
if highlight_arr!=noone{
draw_text(id.x+120,id.y-20,"high_arr_l:" + string(array_length(highlight_arr)))
}
}
